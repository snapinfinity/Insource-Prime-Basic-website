...
const Hero = () => {
  return (
    <BackgroundWrapper bg={bg}>
      <div className="container flex flex-col px-10 pt-10 mx-auto lg:items-center md:flex-row lg:pt-0 md:h-[85vh] h-full">
        <motion.div 
          initial={{ opacity: 0, x: -50 }} 
          animate={{ opacity: 1, x: 0 }} 
          transition={{ duration: 2 }} 
          className="flex flex-col justify-center gap-10 md:w-1/2"
        >
          <motion.h1 
        ...
        >
          <img src={img} alt="Banking" className="h-full lg:w-[90%] w-full" />
        </motion.div>
