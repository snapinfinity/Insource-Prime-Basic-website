...
const GetStarted = () => {
    return (
        <div
            className="relative flex flex-col items-center justify-center py-12 text-center text-white lg:py-24"
            style={{
        ...
        >
            <div className="container px-10 mx-auto ">
                ...
                <p className="md:w-[80%] w-full mx-auto mb-8 text-lg text-left md:text-center ">
